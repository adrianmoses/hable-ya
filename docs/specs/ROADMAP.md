...
| 021 | WebSocket `/ws/session` voice session endpoint | in-progress | [021-voice-pipeline](021-voice-pipeline/spec.md) |
| 022 | Pipecat pipeline composition (VAD → STT → prompt builder → LLM → tool handler → TTS) | in-progress | [021-voice-pipeline](021-voice-pipeline/spec.md) |
